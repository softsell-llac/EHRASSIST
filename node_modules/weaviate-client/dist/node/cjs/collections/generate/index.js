...
class GenerateManager {
  ...
  fetchObjects(generate, opts) {
    return this.check
      ...
      .then(({ search }) =>
        search.withFetch(
          Object.assign(Object.assign({}, index_js_3.Serialize.search.fetchObjects(opts)), {
  ...
  bm25(query, generate, opts) {
    return this.check
      ...
      .then(({ search }) =>
        search.withBm25(
          Object.assign(Object.assign({}, index_js_3.Serialize.search.bm25(query, opts)), {
            generative: index_js_3.Serialize.generative(generate),
          })
        )
      )
      ...
      .then(({ search, supportsTargets, supportsVectorsForTargets, supportsWeightsForTargets }) =>
        search.withHybrid(
          Object.assign(
            Object.assign(
              {},
              index_js_3.Serialize.search.hybrid(
                {
                  query,
                  supportsTargets,
      ...
      .then(({ search, supportsTargets, supportsVectorsForTargets, supportsWeightsForTargets }) =>
        search.withNearVector(
          Object.assign(
            Object.assign(
              {},
              index_js_3.Serialize.search.nearVector(
                {
                  vector,
                  supportsTargets,
                  supportsVectorsForTargets,
  ...
  nearMedia(media, type, generate, opts) {
    return this.check
      ...
      .then(({ search, supportsTargets, supportsWeightsForTargets }) => {
            ...
            send = (media) =>
              search.withNearAudio(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.search.nearAudio(Object.assign({ audio: media }, args), opts)
                  ),
                  { generative }
                )
              );
            ...
            send = (media) =>
              search.withNearDepth(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.search.nearDepth(Object.assign({ depth: media }, args), opts)
                  ),
                  { generative }
                )
              );
            ...
            send = (media) =>
              search.withNearImage(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.search.nearImage(Object.assign({ image: media }, args), opts)
                  ),
                  { generative }
                )
              );
            ...
            send = (media) =>
              search.withNearIMU(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.search.nearIMU(Object.assign({ imu: media }, args), opts)
                  ),
                  { generative }
                )
              );
            ...
            send = (media) =>
              search.withNearThermal(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.search.nearThermal(Object.assign({ thermal: media }, args), opts)
                  ),
                  { generative }
                )
              );
            ...
            send = (media) =>
              search.withNearVideo(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.search.nearVideo(Object.assign({ video: media }, args))
                  ),
                  { generative }
                )
              );
        ...
        return (0, index_js_1.toBase64FromMedia)(media).then(send);
      })
      .then((reply) => this.parseGroupByReply(opts, reply));
  }
}
