  ...
  constructor(connection, name, dbVersionSupport, consistencyLevel, tenant) {
    ...
    this.checkSupportForNamedVectors = (opts) =>
      __awaiter(this, void 0, void 0, function* () {
        if (!index_js_1.Serialize.isNamedVectors(opts)) return;
    ...
    this.checkSupportForBm25AndHybridGroupByQueries = (query, opts) =>
      __awaiter(this, void 0, void 0, function* () {
        if (!index_js_1.Serialize.search.isGroupBy(opts)) return;
    ...
    this.checkSupportForMultiTargetSearch = (opts) =>
      __awaiter(this, void 0, void 0, function* () {
        if (!index_js_1.Serialize.isMultiTarget(opts)) return false;
    ...
    this.checkSupportForMultiVectorSearch = (vec) =>
      __awaiter(this, void 0, void 0, function* () {
        if (vec === undefined || index_js_1.Serialize.isHybridNearTextSearch(vec)) return false;
        if (
          index_js_1.Serialize.isHybridNearVectorSearch(vec) &&
          !index_js_1.Serialize.isMultiVector(vec.vector)
        )
          return false;
        if (index_js_1.Serialize.isHybridVectorSearch(vec) && !index_js_1.Serialize.isMultiVector(vec))
          return false;
    ...
    this.checkSupportForMultiWeightPerTargetSearch = (opts) =>
      __awaiter(this, void 0, void 0, function* () {
        if (!index_js_1.Serialize.isMultiWeightPerTarget(opts)) return false;
    ...
    this.checkSupportForMultiVectorPerTargetSearch = (vec) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (
          index_js_1.Serialize.isHybridNearVectorSearch(vec) &&
          !index_js_1.Serialize.isMultiVectorPerTarget(vec.vector)
        )
          return false;
        if (
          index_js_1.Serialize.isHybridVectorSearch(vec) &&
          !index_js_1.Serialize.isMultiVectorPerTarget(vec)
        )
          return false;
