...
Aggregate.aggregations = (returnMetrics) => {
  ...
  return returnMetrics.map((metric) =>
    aggregate_js_1.AggregateRequest_Aggregation.fromPartial({
      property: metric.propertyName,
      boolean:
        metric.kind === 'boolean'
          ? aggregate_js_1.AggregateRequest_Aggregation_Boolean.fromPartial(metric)
          : undefined,
      date:
        metric.kind === 'date'
          ? aggregate_js_1.AggregateRequest_Aggregation_DateMessage.fromPartial(metric)
          : undefined,
      int:
        metric.kind === 'integer'
          ? aggregate_js_1.AggregateRequest_Aggregation_Integer.fromPartial(metric)
          : undefined,
      number:
        metric.kind === 'number'
          ? aggregate_js_1.AggregateRequest_Aggregation_Number.fromPartial(metric)
          : undefined,
      text:
        metric.kind === 'text'
...
Aggregate.common = (opts) => {
  return {
    filters: (opts === null || opts === void 0 ? void 0 : opts.filters)
      ? Serialize.filtersGRPC(opts.filters)
      : undefined,
    aggregations: Aggregate.aggregations(opts === null || opts === void 0 ? void 0 : opts.returnMetrics),
  };
};
...
Aggregate.hybrid = (query, opts) => {
  return Object.assign(Object.assign({}, Aggregate.common(opts)), {
    objectLimit: opts === null || opts === void 0 ? void 0 : opts.objectLimit,
...
Aggregate.nearImage = (image, opts) => {
  return Object.assign(Object.assign({}, Aggregate.common(opts)), {
    ...
    nearImage: Serialize.nearImageSearch(
      Object.assign({ image, supportsTargets: true, supportsWeightsForTargets: true }, opts)
    ),
  });
};
Aggregate.nearObject = (id, opts) => {
  return Object.assign(Object.assign({}, Aggregate.common(opts)), {
    ...
    nearObject: Serialize.nearObjectSearch(
      Object.assign({ id, supportsTargets: true, supportsWeightsForTargets: true }, opts)
    ),
  });
};
Aggregate.nearText = (query, opts) => {
  return Object.assign(Object.assign({}, Aggregate.common(opts)), {
    ...
    nearText: Serialize.nearTextSearch(
      Object.assign({ query, supportsTargets: true, supportsWeightsForTargets: true }, opts)
    ),
  });
};
Aggregate.nearVector = (vector, opts) => {
  return Object.assign(Object.assign({}, Aggregate.common(opts)), {
    objectLimit: opts === null || opts === void 0 ? void 0 : opts.objectLimit,
    nearVector: Serialize.nearVectorSearch(
      Object.assign(
        { vector, supportsTargets: true, supportsVectorsForTargets: true, supportsWeightsForTargets: true },
        opts
      )
    ),
  });
};
Aggregate.overAll = (opts) => Aggregate.common(opts);
class Search {}
...
Search.bm25 = (query, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    bm25Search: Serialize.bm25Search(Object.assign({ query }, opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.fetchObjects = (args) => {
  return Object.assign(Object.assign({}, Search.common(args)), {
    after: args === null || args === void 0 ? void 0 : args.after,
    sortBy: (args === null || args === void 0 ? void 0 : args.sort)
      ? Search.sortBy(args.sort.sorts)
      : undefined,
  });
};
...
Search.hybrid = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    hybridSearch: Serialize.hybridSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearAudio = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearAudio: Serialize.nearAudioSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearDepth = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearDepth: Serialize.nearDepthSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearImage = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearImage: Serialize.nearImageSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearIMU = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearIMU: Serialize.nearIMUSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearObject = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearObject: Serialize.nearObjectSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearText = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearText: Serialize.nearTextSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearThermal = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearThermal: Serialize.nearThermalSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearVector = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearVector: Serialize.nearVectorSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
Search.nearVideo = (args, opts) => {
  return Object.assign(Object.assign({}, Search.common(opts)), {
    nearVideo: Serialize.nearVideoSearch(Object.assign(Object.assign({}, args), opts)),
    groupBy: Search.isGroupBy(opts) ? Search.groupBy(opts.groupBy) : undefined,
  });
};
class Serialize {
...
Serialize.isMultiTarget = (opts) => {
  return (
    (opts === null || opts === void 0 ? void 0 : opts.targetVector) !== undefined &&
    !utils_js_1.TargetVectorInputGuards.isSingle(opts.targetVector)
  );
};
...
Serialize.isMultiVectorPerTarget = (vec) => {
  return (
    vec !== undefined && !Array.isArray(vec) && Object.values(vec).some(utils_js_1.ArrayInputGuards.is2DArray)
  );
};
Serialize.generative = (generative) => {
  return generative_js_1.GenerativeSearch.fromPartial({
...
Serialize.isHybridVectorSearch = (vector) => {
  return vector !== undefined && !_a.isHybridNearTextSearch(vector) && !_a.isHybridNearVectorSearch(vector);
};
...
Serialize.hybridVector = (args) => {
  ...
  if (_a.isHybridVectorSearch(vector)) {
    const { targets, targetVectors, vectorBytes, vectorPerTarget, vectorForTargets } = _a.vectors(
  ...
  } else if (_a.isHybridNearTextSearch(vector)) {
    const { targetVectors, targets } = _a.targetVector(args);
    return {
      targets,
      targetVectors,
      nearText: base_search_js_1.NearTextSearch.fromPartial({
        ...
        moveAway: vector.moveAway
          ? base_search_js_1.NearTextSearch_Move.fromPartial(vector.moveAway)
          : undefined,
        moveTo: vector.moveTo ? base_search_js_1.NearTextSearch_Move.fromPartial(vector.moveTo) : undefined,
      }),
    };
  } else if (_a.isHybridNearVectorSearch(vector)) {
    const { targetVectors, targets, vectorBytes, vectorPerTarget, vectorForTargets } = _a.vectors(
    ...
    const { targets, targetVectors } = _a.targetVector(args);
    return { targets, targetVectors };
  }
};
Serialize.hybridSearch = (args) => {
  ...
  const { targets, targetVectors, vectorBytes, nearText, nearVector } = _a.hybridVector(args);
...
Serialize.nearVectorSearch = (args) => {
  ...
  return base_search_js_1.NearVector.fromPartial({
    certainty: args.certainty,
    distance: args.distance,
    targetVectors,
    targets,
...
Serialize.targetVector = (args) => {
  if (args.targetVector === undefined) {
    ...
    return { targets: _a.targets(args.targetVector, args.supportsWeightsForTargets) };
  }
};
Serialize.vectors = (args) => {
  const invalidVectorError =
    new errors_js_1.WeaviateInvalidInputError(`${args.argumentName} argument must be populated and:
  ...
  if (utils_js_1.NearVectorInputGuards.isObject(args.vector)) {
    ...
    if (args.supportsVectorsForTargets) {
      const vectorForTargets = Object.entries(args.vector)
        ...
        .reduce((acc, { target, vector }) => {
          return utils_js_1.ArrayInputGuards.is2DArray(vector)
            ? acc.concat(vector.map((v) => ({ name: target, vectorBytes: _a.vectorToBytes(v), vectors: [] })))
            : acc.concat([{ name: target, vectorBytes: _a.vectorToBytes(vector), vectors: [] }]);
        }, []);
      return args.targetVector !== undefined
        ? Object.assign(Object.assign({}, _a.targetVector(args)), { vectorForTargets })
        : {
      ...
      Object.entries(args.vector).forEach(([k, v]) => {
        ...
        vectorPerTarget[k] = _a.vectorToBytes(v);
      });
      if (args.targetVector !== undefined) {
        const { targets, targetVectors } = _a.targetVector(args);
        return {
    ...
    if (utils_js_1.NearVectorInputGuards.is1DArray(args.vector)) {
      const { targetVectors, targets } = _a.targetVector(args);
      const vectorBytes = _a.vectorToBytes(args.vector);
      return {
        targetVectors,
        targets,
        vectorBytes,
...
Serialize.filtersGRPC = (filters) => {
  const resolveFilters = (filters) => {
    ...
    (_b = filters.filters) === null || _b === void 0
      ? void 0
      : _b.forEach((val) => out.push(_a.filtersGRPC(val)));
    return out;
  };
  const { value } = filters;
  switch (filters.operator) {
    ...
    default:
      return base_js_1.Filters.fromPartial({
        operator: _a.operator(filters.operator),
...
Serialize.filterTargetToREST = (target) => {
  if (target.property) {
    ...
    return [
      ...
      ..._a.filterTargetToREST(target.multiTarget.target),
    ];
...
Serialize.filtersREST = (filters) => {
  ...
  if (filters.operator === 'And' || filters.operator === 'Or') {
    return {
      ...
      operands: (_b = filters.filters) === null || _b === void 0 ? void 0 : _b.map(_a.filtersREST),
    };
  } else {
    ...
    const out = {
      path: _a.filterTargetToREST(filters.target),
      operator: filters.operator,
    };
    if (FilterGuards.isText(value)) {
...
Serialize.restProperties = (properties, references) => {
  ...
  Object.keys(properties).forEach((key) => {
    ...
    if (DataGuards.isDate(value)) {
      ...
      parsedProperties[key] = value.map((v) => _a.restProperties(v));
    } else if (DataGuards.isNested(value)) {
      parsedProperties[key] = _a.restProperties(value);
    } else {
        ...
        if (classes_js_2.ReferenceGuards.isReferenceManager(v)) {
          ...
          out = out.concat(
            (classes_js_2.ReferenceGuards.isUuid(v.uuids) ? [v.uuids] : v.uuids).map((uuid) =>
              (0, utils_js_2.uuidToBeacon)(uuid, v.targetCollection)
            )
          );
        }
      });
  ...
  const resolveProps = (key, value) => {
    if (DataGuards.isEmptyArray(value)) {
      ...
      objectArrayProperties.push({
        propName: key,
        values: value.map((v) => base_js_1.ObjectPropertiesValue.fromPartial(_a.batchProperties(v))),
      });
    } else if (DataGuards.isNested(value)) {
      const parsed = _a.batchProperties(value);
  ...
  const iterate = (index) => {
    ...
    if (obj.vectors !== undefined && !Array.isArray(obj.vectors)) {
      vectors = Object.entries(obj.vectors).map(([k, v]) =>
        base_js_1.Vectors.fromPartial({
          vectorBytes: _a.vectorToBytes(v),
          name: k,
        })
      );
      ...
      vectors = [
        base_js_1.Vectors.fromPartial({
          vectorBytes: _a.vectorToBytes(obj.vectors),
          name: 'default',
        }),
      ];
      vectorBytes = _a.vectorToBytes(obj.vectors);
    ...
    objs.push(
      batch_js_1.BatchObject.fromPartial({
        ...
        properties: _a.batchProperties(obj.properties, obj.references),
        tenant: tenant,
