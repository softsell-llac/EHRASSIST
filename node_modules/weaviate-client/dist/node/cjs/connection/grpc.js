...
class ConnectionGRPC extends gql_js_1.default {
  ...
  static connect(params, grpcMaxLengthPromise) {
    return __awaiter(this, void 0, void 0, function* () {
      const connection = yield grpcMaxLengthPromise.then(
        (grpcMaxMessageLength) =>
          new ConnectionGRPC(Object.assign(Object.assign({}, params), { grpcMaxMessageLength }))
      );
...
ConnectionGRPC.use = (params) => {
  ...
  if (params.skipInitChecks) {
    return {
      connection: new ConnectionGRPC(
        Object.assign(Object.assign({}, params), { grpcMaxMessageLength: MAX_GRPC_MESSAGE_LENGTH })
      ),
      dbVersionProvider,
      dbVersionSupport,
    };
  ...
  return Promise.all([
    ConnectionGRPC.connect(
      params,
      rest.get('/meta', true).then((res) => res.grpcMaxMessageSize || MAX_GRPC_MESSAGE_LENGTH)
    ),
...
const grpcClient = (config) => {
  ...
  return {
    aggregate: (collection, consistencyLevel, tenant, bearerToken) => {
      var _a;
      return aggregator_js_1.default.use(
        client,
        collection,
    ...
    health: () => {
      ...
      const timeoutId = setTimeout(
        () => controller.abort(),
        (((_a = config.timeout) === null || _a === void 0 ? void 0 : _a.init) || 2) * 1000
      );
      return health
...
const getMetadataWithEmbeddingServiceAuth = (config, bearerToken) =>
  new nice_grpc_1.Metadata(
    bearerToken
